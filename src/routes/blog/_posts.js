...
// underscore tells Ramber not to do that.
...
const posts = [
	...
	{
		title: 'How is Ramber different from Next.js?',
		slug: 'how-is-ramber-different-from-next',
		html: `
			<p><a href='https://github.com/zeit/next.js'>Next.js</a> is a React framework from <a href='https://vercel.com/'>Vercel</a>, and is the inspiration for Ramber. There are a few notable differences, however:</p>

			<ul>
				<li>It's powered by <a href='https://hamberjs.web.app'>Hamber</a> instead of React, so it's faster and your apps are smaller</li>
				<li>Instead of route masking, we encode route parameters in filenames. For example, the page you're looking at right now is <code>src/routes/blog/[slug].hamber</code></li>
				<li>As well as pages (Hamber components, which render on server or client), you can create <em>server routes</em> in your <code>routes</code> directory. These are just <code>.js</code> files that export functions corresponding to HTTP methods, and receive Express <code>request</code> and <code>response</code> objects as arguments. This makes it very easy to, for example, add a JSON API such as the one <a href='blog/how-is-ramber-different-from-next.json'>powering this very page</a></li>
...

	{
		...
		html: `
			<p>We're so glad you asked! Come on over to the <a href='https://github.com/hamberjs/hamber'>Hamber</a> and <a href='https://github.com/hamberjs/ramber'>Ramber</a> repos. Everyone is welcome, especially you!</p>
		`
	}
];
